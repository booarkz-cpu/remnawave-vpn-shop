# Remnawave VPN Shop 2.7.0 — Установка одной командой

Предыдущие установщики: 2.6.0 (платформа антиабьюза и агент узла), 2.5.0 (конструктор тарифов и мониторинг узлов) и 2.4.0 (личный кабинет). Серверная схема остаётся на миграции `0038_v2_6_0_platform`. Приложения Android и iOS установщик VPS не ставит: их собирают из `mobile/` и описывает раздел 9.6 в `INSTRUCTION.md`. Проверка без касс — раздел 9.4. Агент — раздел 9.5. Лицензия — `LICENSE`.
