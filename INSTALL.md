# Remnawave VPN Shop 2.5.0 — Установка одной командой

Предыдущий установщик кабинета: 2.4.0. Текущая версия добавляет конструктор тарифов и мониторинг узлов. Проверка без касс описана в `INSTRUCTION.md`, раздел 9.4.
