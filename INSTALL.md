# Remnawave VPN Shop 2.6.0 — Установка одной командой

Предыдущие установщики: 2.5.0 (конструктор тарифов и мониторинг узлов) и 2.4.0 (личный кабинет). Текущая версия добавляет платформу антиабьюза и агент узла. Проверка без касс описана в `INSTRUCTION.md`, раздел 9.4. Агент ставится отдельно и описан в разделе 9.5. Лицензия — `LICENSE`.
