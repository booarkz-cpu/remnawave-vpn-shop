...
def upgrade():
    ...
    for name, col in [("fulfillment_status", sa.String(32)),("fulfillment_attempts",sa.Integer()),("fulfillment_error",sa.Text()),("next_retry_at",sa.DateTime()),("idempotency_key",sa.String(128))]:
        op.add_column("payments", sa.Column(col.name, col, nullable=True))
